...
class DailyLogAdapter extends TypeAdapter<DailyLog> {
  ...
  DailyLog read(BinaryReader reader) {
    ...
    return DailyLog(
      ...
      screenTimeMinutes: fields[10] as int?,
      updatedAt: fields[11] != null ? DateTime.parse(fields[11] as String) : null,
    );
  }
  ...
  void write(BinaryWriter writer, DailyLog obj) {
    ...
    writer.writeByte(10);
    writer.write(obj.screenTimeMinutes);
    writer.writeByte(11);
...
class HabitAdapter extends TypeAdapter<Habit> {
  ...
  Habit read(BinaryReader reader) {
    ...
    return Habit(
      ...
      goalDirection: fields[9] != null
          ? GoalDirection.values.firstWhere((e) => e.name == (fields[9] as String?), orElse: () => GoalDirection.atLeast)
          : GoalDirection.atLeast,
      updatedAt: fields[10] != null ? DateTime.parse(fields[10] as String) : null,
    );
  }
  ...
  void write(BinaryWriter writer, Habit obj) {
    ...
    writer.writeByte(9);
    writer.write(obj.goalDirection.name);
    writer.writeByte(10);
    writer.write(obj.updatedAt?.toIso8601String());
  }
}
...
class HabitCompletionAdapter extends TypeAdapter<HabitCompletion> {
  ...
  HabitCompletion read(BinaryReader reader) {
    ...
    return HabitCompletion(
      ...
      updatedAt: fields[4] != null ? DateTime.parse(fields[4] as String) : null,
    );
  }
...
class BadgeAdapter extends TypeAdapter<Badge> {
  ...
  Badge read(BinaryReader reader) {
    ...
    return Badge(
      ...
      requiredProgress: fields[5] as int,
      currentProgress: fields[6] as int,
      unlockedAt: fields[7] != null ? DateTime.parse(fields[7] as String) : null,
    );
  }
  ...
  void write(BinaryWriter writer, Badge obj) {
    ...
    writer.writeByte(4);
    writer.write(obj.iconEmoji);
    writer.writeByte(5);
    writer.write(obj.requiredProgress);
    writer.writeByte(6);
    writer.write(obj.currentProgress);
    writer.writeByte(7);
    writer.write(obj.unlockedAt?.toIso8601String());
  }
}
