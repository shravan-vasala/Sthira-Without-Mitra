...
const HabitSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'step': PropertySchema(id: 6, name: r'step', type: IsarType.double),
    r'target': PropertySchema(id: 7, name: r'target', type: IsarType.double),
...
Habit _habitDeserialize(
  ...
  final object = Habit(
    ...
    type:
        _HabittypeValueEnumMap[reader.readByteOrNull(offsets[8])] ??
        HabitType.checkbox,
