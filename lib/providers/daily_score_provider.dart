...
class DailyScore {
  ...
  static DailyScore calculate({
    ...
    final double habitsMax = stats.habitsTotal > 0 ? 50 : 0;
    ...
    final double workoutsMax = stats.workoutsTotal > 0 || stats.isRestDay ? 30 : 0;
    if (stats.isRestDay) {
    ...
    double mealsScore = 0;
    final double mealsMax = stats.mealsTotal > 0 ? 20 : 0;
