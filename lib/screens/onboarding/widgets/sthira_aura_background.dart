...
class _SthiraAuraBackgroundState extends State<SthiraAuraBackground>
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.currentPage <= 1) {
      primaryAura = const Color(0xFFE8A163); // Peach
      secondaryAura = const Color(0xFF7A3E1A); // Deep Brown
    } else if (widget.currentPage == 2) {
      primaryAura = const Color(0xFFE8A163); // Peach
      secondaryAura = const Color(0xFF8FB896); // Sage
    } else {
      primaryAura = const Color(0xFF8FB896); // Sage
      secondaryAura = const Color(0xFF1B3B2B); // Deep green
    }
      ...
      builder: (context, child) {
        return Container(
          decoration: BoxDecoration(
            color: const Color(0xFF2E1D2F), // Dark plum base
