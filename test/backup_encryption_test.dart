...
void main() {
  group('BackupEncryptionService', () {
    ...
    final testData = Uint8List.fromList(
      utf8.encode('Hello TruFit Bodamma! This is a test backup payload.'),
    );

    test('round-trip encryption and decryption (v2)', () {
      final encrypted = BackupEncryptionService.encryptBytes(
        testData,
        password,
      );
      ...
      final decrypted = BackupEncryptionService.decryptBytes(
        encrypted,
        password,
      );
